classdef pend_location_down < pend_location
    %PEND_LOCATION_DOWN Pendulum location in the swing-up phase
    ...
    methods
        function obj = pend_location_down(id, vars, supp, supp0, f, param)
            %PEND_LOCATION_DOWN Construct an instance of this class
            %   Detailed explanation goes here            
            obj@pend_location(id, vars, supp, supp0, f, param, pend_type.DOWN);
...
%             u = [-s, w]*obj.K_';
        ...
        function xdot = f_eval(obj, t, x)
            %evaluate the swing-up dynamics at DOWN
            c = cos(x(1));
            s = sin(x(1));
            w = x(2);
